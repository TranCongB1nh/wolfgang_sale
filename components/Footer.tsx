        ...
        <div className='w-full min-h-[500px] bg-light-gray'>
            <div className='mygrid h-full py-5 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-1'>
                <div className='w-full mt-2'>
                    <span className='block font-black text-[25px] text-light-yellow'>Wolfgang Store</span>
                    <span className='block text-white text-[13px]'>&copy; 2023 được phát triển bởi Wolfgang</span>
                    <span className='block text-white text-[13px]'> Bảo lưu mọi quyền.</span>
                </div>
                <div className='w-full mt-2'>
                    <h4 className='font-bold text-[16px] text-light-yellow'>VỀ WOLFGANG</h4>
                ...
                <div className='w-full mt-2'>
                    ...
                    <ul className='w-full mt-2'>
                        <li className='boldOnHover py-1 cursor-pointer'>
                            <Link href="https://agearle.vercel.app/about" className='text-white text-[13px]'>Gọi mua: 0938745593 (8:00 - 21:00)</Link>
                        </li>
                        <li className='boldOnHover py-1 cursor-pointer'>
                            <Link href="https://agearle.vercel.app/about" className='text-white text-[13px]'>Hotline: 0332826845 (8:00 - 21:00)</Link>
                        </li>
                        <li className='boldOnHover py-1 cursor-pointer'>
                            <Link href="https://agearle.vercel.app/about" className='text-white text-[13px]'>Email: cskh.wolfgang@gmail.com</Link>
                        </li>
                    </ul>
                </div>
                <div className='w-full mt-2'>
