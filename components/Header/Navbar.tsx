    ...
    <header className='shadow-header fixed z-10 top-0 w-full h-[70px] bg-white'>
      <nav className='mygrid relative flex justify-between h-full items-center'>
        ...
        <div className='flex justify-between h-full items-center'>
          {/* HOTLINE */}
          <Link href="tel:0332826845" className='min-w-[120px] px-2 h-full text-[13px] flex justify-center items-center border-b-[2px] border-white hover:border-b-[2px] hover:border-black transition ease-in-out relative'>
            <HeadsetMicOutlinedIcon className='myicon' />
            <p><b>Hotline</b> <br></br> 0332826845</p>
          </Link>
