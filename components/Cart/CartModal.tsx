...
export const Cart = ({ isOpen, closeModal }: CartProps) => {
    ...
    const deleteFromCart = (_id: any, size: any) => {
        dispatch(deleteItems({ _id, size }))
    }
                                                    ...
                                                    <div key={product._id}>
                                                        <li className='flex justify-between items-center w-full h-[100px]  p-[10px]'>
                                                            <div className='w-[65px] h-[65px] relative '>
                                                                ...
                                                                />
                                                                <div onClick={(e) => {
                                                                    deleteFromCart(product._id, product.size)
                                                            ...
                                                            <div className='w-[50%] h-[60px] text-justify'>
                                                                <div className='text-left overflow-hidden w-full h-[35px] '>
                                                                    <span className='font-medium text-[16px] leading-5 line-clamp-2 overflow-hidden whitespace-pre-wrap'>
                                                                        {product.name}
                                                                    </span>
                                                                </div>
                                                                <span className="flex w-full h-fit text-[12px]">Size: {product.size}</span>
                                                                <span className='w-full text-[13px]'>{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(product.salePrice)}</span>
                                                            </div>
