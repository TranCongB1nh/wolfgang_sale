    ...
    return (
        <div className='w-full overflow-hidden relative rounded-[10px] drop-shadow-xl'>
            <div className=' relative w-full z-0 aspect-square rounded-[10px] overflow-hidden'>
                ...
                <div onClick={addFavourite} className='absolute z-[1] w-[110px] h-[30px] top-2 right-[-75px] badge flex items-center justify-start cursor-pointer p-2 rounded-s mb-1 backdrop-blur-sm bg-light-red/30 transition-all hover:right-0'>
